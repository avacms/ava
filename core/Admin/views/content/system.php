<?php
/**
 * System Info - Content Only View
 * 
 * Available variables:
 * - $system: System info array (disk_free, disk_total, memory_used, memory_peak, load_avg, uptime, opcache, hostname)
 * - $cacheFiles: Array of cache files with metadata
 * - $directories: Directory status array
 * - $pathAliases: Path aliases array
 * - $hooks: Registered hooks info
 * - $avaConfig: Ava configuration summary
 * - $debugInfo: Debug/error information
 * - $cache: Cache status array
 * - $csrf: CSRF token
 * - $admin_url: Admin URL
 */
?>
